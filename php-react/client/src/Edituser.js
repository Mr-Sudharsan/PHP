...
class Edituser extends Component {
  ...
  componentDidMount() {
    axios
      .get(`http://localhost:1011/customer/view-one.php?customer_id=` + this.props.match.params.customer_id)
      .then((response) => {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:1011/customer/update.php?customer_id=' + this.props.match.params.customer_id, userObject, {
      headers: {
          ...
          <Container>
            <Form onSubmit={this.onSubmit}>
              ...
              <FormGroup row>
                ...
                <Col sm={10}>
                  <Input type="textarea" name="customer_adress" value={this.state.customer_address} onChange={this.onChangeAddress} required />
                </Col>
              </FormGroup>
